...
class SB_TwigExtension extends AbstractExtension
{
    private $translator;
    ...
    {
        return array(
            new TwigFunction('dateCourte', array($this, 'date_courte')),
            new TwigFunction('dateLongue', array($this, 'date_longue')),
            new TwigFunction('timetableLine', array($this, 'timetable_line')),
            new TwigFunction('periode', array($this, 'periode')),
        );
    }
